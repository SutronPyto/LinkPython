...
# micropython lacks ljust:
def ljust(s, sz, ch=b' '):
   return s[:sz] + ch * (sz-len(s))
...
class XMODEM(object):
    ...
    Example functions for reading and writing on the SL3:
    >>> import xmodem, serial
    >>> s = serial.Serial('RS232')
    ...
    ...
    >>> modem = XMODEM(getc, putc, 'xmodem1k')
    ...
    def send(self, stream, retry=16, timeout=60, quiet=False, callback=None):
        ...
        while True:
            ...
            data = ljust(data, packet_size, self.pad)
